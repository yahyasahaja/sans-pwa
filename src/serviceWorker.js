...
import { serviceWorker as sw } from './services/stores'
...
export function register(config) {
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    ...
    window.addEventListener('load', () => {
      ...
      console.log('Valid Host:', !isLocalhost)
      ...
      registration.onupdatefound = () => {
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            console.log('installing sw:', navigator.serviceWorker.controller)
  ...
  navigator.serviceWorker.ready.then(registration => {
    ...
    if (activatingWorker.state === 'activated') {
      ...
      activatingWorker.onstatechange = () => {
        console.log('service worker state: ', activatingWorker.state)
        if (activatingWorker.state === 'activated') {
          subscribeRegistration(registration)
        }
      }

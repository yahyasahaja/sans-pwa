...
@observer
class ViewAllExperiences extends Component {
        ...
        <div className="wrapper" >
          ...
          <div>
            <Button
              color="primary"
              variant="contained"
              onClick={() => this.props.history.push('/customers/profile/experiences/new')}
  ...
  renderList() {
    return profileState.profile.experiences.map((d, i) => (
...
export default ViewAllExperiences